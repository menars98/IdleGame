...
#include "Components/IdleCivManagerComponent.h"
...
void UIdleCivManagerComponent::DiagnoseMapDataAtPoint(FIntPoint PointToTest)
{
...
void UIdleCivManagerComponent::InitializeMapArray()
{
    ...
    GetWorld()->GetTimerManager().SetTimer(ExpansionTimerHandle, this, &UIdleCivManagerComponent::ExpandCivilizations, 0.05f, true, 2.0f);
}

void UIdleCivManagerComponent::ClaimInitialAreaForCivilization(FIntPoint Center, int32 Radius, int32 CivID, FColor CivColor)
{
    if (CivID < 0) return;
...
void UIdleCivManagerComponent::ClaimTileForCivilization(FIntPoint Location, int32 CivID, FColor CivColor)
{
    // Border control 
...
void UIdleCivManagerComponent::UpdateCivilizationData(const TMap<int32, FColor>& CivColorMap)
{
    CurrentCivColors = CivColorMap;
}

FIntPoint UIdleCivManagerComponent::GetRandomSpawnableLocation()
{
...
int32 UIdleCivManagerComponent::GetRegionIDAtLocation(FIntPoint Location)
{
...
void UIdleCivManagerComponent::ExpandCivilizations()
{
...
void UIdleCivManagerComponent::UpdateTextureWithColor(FIntPoint Location, FColor Color)
{
...
void UIdleCivManagerComponent::FindAllSpawnableLocations()
{
...
void UIdleCivManagerComponent::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void UIdleCivManagerComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
